...
ActiveRecord::Schema.define(version: 20150304234040) do
  ...
  add_index "taggings", ["topic_id", "tagger_id", "url_id"], name: "index_taggings_on_topic_id_and_tagger_id_and_url_id", unique: true
